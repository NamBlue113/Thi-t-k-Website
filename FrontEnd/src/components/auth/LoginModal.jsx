...
// Google Sign-In + Forgot password link
// ============================================
...
export default function LoginModal({ open, onClose, onSwitchToRegister, onOpenForgotPassword }) {
      ...
      <div className="modal">
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            ...
            <input type="text" placeholder="Nhập email hoặc tên đăng nhập" value={email} onChange={(e) => setEmail(e.target.value)} />
          </div>
          <div className="form-group">
